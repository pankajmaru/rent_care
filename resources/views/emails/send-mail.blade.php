    ...
    <div class="invoice-body">
        <section id="items">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <th>Sr No.</th> <!-- Dummy cell for the row number and row commands -->
                    <th>Particulrs</th>
                    <th>Electricy</th>
                    <th>Water</th>
                    <th>Rent</th>
                ...
                <tr data-iterate="item">
                    ...
                    <td>{{ $bills->user->first_name  }}</td>
                    <td>{{ $bills->electricity_unit  }}</td>
                    <td>{{ $bills->water_unit  }}</td>
                    <td>{{ $bills->room->rent_amount  }}</td>
                    <td>0</td>
        ...
        <section id="sums">
            <table cellpadding="0" cellspacing="0">           
                <tr data-hide-on-quote="true">
                    <th>Amount Paid</th>
                    <td></td>
                    <td>{{ $bills->total_paid }}</td>
                </tr>
                <tr data-hide-on-quote="true">
                    <th>Amount Due</th>
                    <td></td>
                    <td>{{ $bills->total_dues }}</td>
                </tr>
            </table>
        </section>
      </div>
