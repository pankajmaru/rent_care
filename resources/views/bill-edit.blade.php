                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Mobile Number"
                                        name="mobile_number" value="{{ $bills->name->mobile_number }}">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Sub Total" name="sub_total" value="{{ $bills->sub_total }}">
                                ...
                                <div class="form-group col-md-6">
                                    <label>GST</label>
                                    <input type="text" class="form-control" placeholder="GST" name="gst" value="{{ $bills->gst }}">
                                    @if ($errors->has('gst'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Net Amount" name="net_amount" value="{{ $bills->net_amount }}">
